...
4. **Síntese e Estruturação do Resumo Teórico:** Gere o resumo em blocos curtos, focando na clareza.
...
2. Formatação estrita das tags de cores. Nunca altere o texto exato da tag (ex: não escreva "PÉROLA CLÍNICA", use "PÉROLA").
...
[Mecanismo de Ação detalhado, passo a passo se necessário]
