    ...
    "cells": [
        ...
        },
        {
            ...
            "source": [
                ...
                "\n",
                "[C] - CONTEXTO\n",
                "Você recebe os sumários (TOC) extraídos dos livros em PDF (Ground Truth). Cada linha possui Nível Hierárquico, Título do Capítulo/Seção e Página Inicial.\n",
                "\n",
                ...
                "   - Se o capítulo mapeado for a fonte primária e cobrir mais de 60% do tema do objetivo -> cite o capítulo completo (ex: pp. 245–259).\n",
                "   - Se apenas uma subseção específica for relevante -> afunile para a subseção (ex: pp. 237–244).\n",
                ...
                "5. Cálculo Fiel de Limites: Defina `pagina_inicial` e `pagina_final` (sendo exatamente a página do capítulo seguinte menos 1).\n",
                "\n",
                "[N] - NORMAS (CRÍTICO)\n",
                ...
                "- POSITIVO: Cite o intervalo de páginas completo (ex: pagina_inicial: 245, pagina_final: 259).\n",
                ...
                "Sumário Disponível:\n",
                "  - Cap. 12: Angiogênese Tumoral (Página: 230)\n",
                "    -- Metástase Envolvida na Angiogênese (Página: 237)\n",
                "  - Cap. 13: Invasão Tumoral e Metástase (Página: 245)\n",
                "  - Cap. 14: Diagnóstico das Neoplasias (Página: 260)\n",
                "\n",
                "Output (Dois Cortes Mapeados):\n",
                "Corte 1: capitulo: \"12 Angiogênese Tumoral\", pagina_inicial: 237, pagina_final: 244, nivel: \"mecanismo\"\n",
                "Corte 2: capitulo: \"13 Invasão Tumoral e Metástase\", pagina_inicial: 245, pagina_final: 259, nivel: \"mecanismo\"\n",
                "\n",
                ...
                "Sumário Disponível:\n",
                "  - Cap. 17: Biomarcadores no Câncer (Página: 315)\n",
                "  - Cap. 18: Terapia Alvo (Página: 328)\n",
                "\n",
                "Output:\n",
                "Corte 1: capitulo: \"17 Biomarcadores no Câncer\", pagina_inicial: 315, pagina_final: 327, nivel: \"clinica\"\n",
                "\n",
                "[S] - SAÍDA\n",
