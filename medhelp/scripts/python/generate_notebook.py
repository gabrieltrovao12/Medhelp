    ...
    "cells": [
        ...
        },
        {
            ...
            "source": [
                ...
                "\n",
                "[C] - CONTEXTO\n",
                "Você recebe os sumários (TOC) extraídos dos livros em PDF (Ground Truth). Cada linha possui Nível Hierárquico, Título do Capítulo/Seção e Página Inicial FÍSICA do leitor de PDF.\n",
                "ATENÇÃO CRÍTICA: Os números de página indicados nos sumários correspondem estritamente às PÁGINAS FÍSICAS DO ARQUIVO PDF (número da página no leitor de PDF), E NÃO às páginas impressas no rodapé do livro.\n",
                "\n",
                ...
                "   - Se o capítulo mapeado for a fonte primária e cobrir mais de 60% do tema do objetivo -> cite o capítulo completo (ex: pp. 260–275).\n",
                "   - Se apenas uma subseção específica for relevante -> afunile para a subseção (ex: pp. 240–259).\n",
                ...
                "5. Cálculo Fiel de Limites: Defina `pagina_inicial` e `pagina_final` utilizando EXCLUSIVAMENTE os números de páginas físicas presentes nos sumários (sendo `pagina_final` exatamente a página física do capítulo seguinte menos 1).\n",
                "\n",
                "[N] - NORMAS (CRÍTICO)\n",
                "- REGRA DE OURO (PÁGINAS FÍSICAS DO PDF): Use EXCLUSIVAMENTE a numeração de página física do PDF fornecida no sumário. NUNCA use a numeração impressa no rodapé do livro nem subtraia/some offsets fictícios.\n",
                ...
                "- POSITIVO: Cite o intervalo de páginas completo baseado nas páginas físicas (ex: Cap 12 = pagina_inicial: 240, pagina_final: 259; Cap 13 = pagina_inicial: 260, pagina_final: 275).\n",
                "- NEGATIVO: NUNCA misture a página física do início do capítulo com a página impressa no rodapé para o fim do capítulo.\n",
                "- NEGATIVO: NUNCA retorne pagina_final igual a pagina_inicial (ex: 260 -> 260).\n",
                ...
                "Sumário Disponível (Páginas Físicas do PDF):\n",
                "  - Cap. 12: Angiogênese Tumoral (Página: 240)\n",
                "  - Cap. 13: Invasão Tumoral e Metástase (Página: 260)\n",
                "  - Cap. 14: Diagnóstico das Neoplasias (Página: 276)\n",
                "\n",
                "Output (Dois Cortes Mapeados em Páginas Físicas):\n",
                "Corte 1: capitulo: \"12 Angiogênese Tumoral\", pagina_inicial: 240, pagina_final: 259, nivel: \"mecanismo\"\n",
                "Corte 2: capitulo: \"13 Invasão Tumoral e Metástase\", pagina_inicial: 260, pagina_final: 275, nivel: \"mecanismo\"\n",
                "\n",
                ...
                "Sumário Disponível (Páginas Físicas do PDF):\n",
                "  - Cap. 17: Biomarcadores no Câncer (Página: 316)\n",
                "  - Cap. 18: Terapia Alvo (Página: 329)\n",
                "\n",
                "Output:\n",
