    ...
    "cells": [
        ...
        },
        {
            ...
            "source": [
                ...
                "Atuar como um especialista em estruturação de metadados, extraindo o Sumário (Table of Contents - TOC) exato de livros de medicina.\n",
                "\n",
                "[C] - CONTEXTO\n",
                "O texto fornecido representa as primeiras páginas de um livro em formato PDF. As quebras de página estão indicadas no texto.\n",
                "\n",
                "[A] - AÇÕES\n",
                "1. Varra o texto buscando identificar o início da seção \"Sumário\" ou \"Índice\".\n",
                "2. Extraia exaustivamente CADA item listado no sumário.\n",
                "3. Para cada item, determine o seu Nível Hierárquico (ex: Parte I = 1, Capítulo = 2, Subseção = 3).\n",
                ...
                "- NEGATIVO: NÃO extraia listas de tabelas, prefácios isolados se não fizerem parte da árvore principal.\n",
                "- POSITIVO: Siga estritamente o Schema JSON exigido.\n",
                "\n",
                "[E] - EXEMPLOS\n",
                "Input: \"...Parte I - Princípios. 1. Biologia Celular... 14.  Parte II - Patologia. 2. Inflamação... 45...\"\n",
                "Output:\n",
                "Nivel: 1, Titulo: \"Parte I - Princípios\", Pagina: 14\n",
                "Nivel: 2, Titulo: \"1. Biologia Celular\", Pagina: 14\n",
                "Nivel: 1, Titulo: \"Parte II - Patologia\", Pagina: 45\n",
                "Nivel: 2, Titulo: \"2. Inflamação\", Pagina: 45\n",
                "\n",
                "[S] - SAÍDA\n",
                ...
                "5. Defina a `pagina_final` sendo exatamente a página do item IMEDIATAMENTE SEGUINTE no sumário, menos 1.\n",
                "6. Classifique o nível didático do corte (`conceito`, `mecanismo` ou `clinica`).\n",
                "\n",
                "[N] - NORMAS (CRÍTICO)\n",
                "- POSITIVO/NORMAS: A `pagina_final` DEVE ser estritamente MAIOR que a `pagina_inicial` (diferença mínima recomendada de 2 a 5 páginas). NUNCA retorne `pagina_final` menor ou igual a `pagina_inicial`. Se o próximo item do sumário tiver página menor ou inconsistente, estipule a `pagina_final` como `pagina_inicial + 20` páginas.\n",
                "- NEGATIVO: NUNCA mapeie um capítulo inteiro (ex: \"Fármacos de Abuso\") se houver subseções menores (ex: \"Cocaína\") que respondam ao objetivo.\n",
                ...
                "- POSITIVO: Se o termo exato (ex: 'Metástase') não estiver no sumário, infira e mapeie o capítulo maior que logicamente engloba o assunto (ex: 'Neoplasias' ou 'Patologia Celular'). Não retorne lista vazia se houver um capítulo óbvio para o tema.\n",
                ...
                "                    if eh_titulo_em_ingles(title):\n",
                "                        logging.info(f\"Desconsiderando vídeo em inglês no backend: '{title}'\")\n",
                "                        continue\n",
                "                    resultados.append({\n",
                "                        'id': item['id']['videoId'],\n",
                "                        'title': title,\n",
                ...
                "3. **Alucinação Zero:** NUNCA invente um ID de vídeo que não esteja explicitamente listado nas opções.\n",
                ...
                "                if curadoria and curadoria.video_escolhido_id != \"NENHUM\":\n",
                "                    if not hasattr(obj, 'videos') or obj.videos is None:\n",
                "                        obj.videos = []\n",
                "                    obj.videos.append(VideoSugerido(\n",
                "                        termo_busca=termo,\n",
                "                        video_id=curadoria.video_escolhido_id,\n",
                "                        titulo_formatado=curadoria.titulo_formatado\n",
                "                    ))\n",
                "                    print(f\"     ✅ Vídeo Curado para '{termo}': {curadoria.titulo_formatado}\")\n",
                "                else:\n",
