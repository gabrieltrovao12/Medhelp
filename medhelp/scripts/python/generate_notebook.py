    ...
    "cells": [
        ...
        },
        {
            ...
            "source": [
                ...
                "Input (Simplificado):\n",
                "Objetivo: \"Fisiopatologia da metástase e cascata metastática.\"\n",
                "Texto Extraído: (Páginas 260 a 274 do livro)\n",
                "\n",
                "Output:\n",
                "`pagina_inicial_ajustada`: 260, `pagina_final_ajustada`: 274, `resumo_cobertura`: \"Validados os conceitos de invasão tecidual, intravasamento, disseminação vascular e angiogênese tumoral.\"\n",
                "\n",
                "[S] - SAÍDA\n",
