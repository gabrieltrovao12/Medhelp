    ...
    "cells": [
        ...
        },
        {
            ...
            "source": [
                ...
                "3. Se o objetivo contiver temas como 'metástase', 'invasão', 'angiogênese', busal a subseção exata correspondente no sumário (ex: 'Invasão Tumoral e Metástase'). NUNCA selecione 'Introdução' se houver um capítulo de metástase.\n",
                ...
                "Nível 1: 13 Invasão Tumoral e Metástase (p.245)\n",
                "\n",
                "Raciocínio: O objetivo pede metástase. O capítulo 13 aborda exatamente \"Invasão Tumoral e Metástase\". Devo mapear o capítulo 13.\n",
                "Cortes Gerados: \n",
                "- Corte 1: \"13 Invasão Tumoral e Metástase\" (p.245 até 265).\n",
                "\n",
                "[S] - SAÍDA\n",
