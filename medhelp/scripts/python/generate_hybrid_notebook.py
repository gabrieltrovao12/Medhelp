...
cells.append(code(lines(
    ...
    "                logging.error(f'Erro com {model_to_use} (Tentativa {tentativa+1}/{max_retries}): {e}')",
    ...
    "        elems.append(Paragraph(html.escape(nome), s_livro))",
    "        if capitulo:",
    "            elems.append(Paragraph(html.escape(capitulo), s_cap))",
    "        if secao:",
    "            elems.append(Paragraph(f'› {html.escape(secao)}', s_sec))",
    "",
    "        pagina_atual += 1 + n",
    "",
